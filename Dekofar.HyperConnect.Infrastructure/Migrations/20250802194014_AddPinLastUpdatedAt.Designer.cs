...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dekofar.HyperConnect.Domain.Entities.ApplicationUser", b =>
                {
                    ...
                    b.Property<DateTime?>("LastSupportActivity")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<DateTime?>("PinLastUpdatedAt")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<int>("TotalSupportRequestCount")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Dekofar.HyperConnect.Domain.Entities.SupportTicket", b =>
                {
                    ...
                    b.Property<int>("UnreadReplyCount")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0);
            ...
            modelBuilder.Entity("Dekofar.HyperConnect.Domain.Entities.SupportTicketReply", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Dekofar.HyperConnect.Domain.Entities.Commission", b =>
                {
                    b.HasOne("Dekofar.HyperConnect.Domain.Entities.Order", "Order")
                        .WithMany()
            ...
            modelBuilder.Entity("Dekofar.HyperConnect.Domain.Entities.SupportTicketReply", b =>
                {
                    b.HasOne("Dekofar.HyperConnect.Domain.Entities.SupportTicket", "Ticket")
                        .WithMany()
